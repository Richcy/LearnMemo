<?php 
    ...
    while ($continue) {
        ...
        $totalOccurrence = substr_count($lowerMessage, $lowerWord);

        // Loop to find the positions of the character or word within the given message.
        for ($i = 0; $i < $totalOccurrence; $i++) {
        ...
        if (!empty($positions)) {
            ...
            echo "The " . (strlen($word) > 1 ? "word" : "character") . " '" . $word . "' is found " . $totalOccurrence . " times in the string.\n";
